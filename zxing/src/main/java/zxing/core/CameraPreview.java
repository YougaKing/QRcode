...
import zxing.core.camera.CameraInstance;
import zxing.core.camera.CameraSettings;
import zxing.core.camera.CameraSurface;
import zxing.core.camera.CenterCropStrategy;
import zxing.core.camera.FitCenterStrategy;
import zxing.core.camera.DisplayConfiguration;
import zxing.core.camera.FitXYStrategy;
import zxing.core.camera.PreviewScalingStrategy;
...
public class CameraPreview extends ViewGroup {
    ...
    protected Rect calculateFramingRect(Rect container, Rect surface) {
        ...
        intersection.inset(width, width);
        return intersection;
    }
