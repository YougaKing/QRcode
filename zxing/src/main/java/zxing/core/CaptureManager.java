...
import zxing.google.BeepManager;
import zxing.google.InactivityTimer;
import zxing.google.Intents;
...
public class CaptureManager {
    ...
    public CaptureManager(Activity activity, CompoundBarcodeView barcodeView, CaptureCallBack captureCallBack) {
    ...
    protected void returnResult(BarcodeResult rawResult) {
        captureCallBack.onResult(rawResult);
    }
